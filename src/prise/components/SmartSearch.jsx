                ...
                {suggestions.map((item) => (
                  <li key={item.id} role="option">
                    <button
                      ...
                      className="w-full px-4 py-3.5 text-left text-[15px] font-medium tracking-[-0.02em] text-[var(--text-primary)] transition-colors hover:bg-[var(--bg-elevated)] focus-visible:outline-none focus-visible:bg-[var(--bg-elevated)]"
                    >
                      {item.label}
                    </button>
                  </li>
