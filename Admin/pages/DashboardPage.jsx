...
const QUICK_LINKS = [
  ...
  { to: '/admin/settings/company', label: 'Компания', icon: Building2, group: 'Контент' },
  { to: '/admin/main?tab=banners', label: 'Баннеры главной', icon: Image, group: 'Главная' },
  { to: '/admin/main?tab=about', label: 'О нас и карта', icon: MapPin, group: 'Главная' },
